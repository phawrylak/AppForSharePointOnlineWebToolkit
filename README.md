...
2. Changed SharePointContextFilterAttribute to authentication filter (this causes execution on earlier request stage and allows to write authorization filter that connect to SharePoint).